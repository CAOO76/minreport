        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    {/* Modal: centered in the workspace area */}
                    <div
                    ...
                    >
                        <motion.div
                            ...
                            className="elite-tech-surface border border-black/10 dark:border-white/10 z-[101] flex flex-col overflow-hidden pointer-events-auto w-full max-w-2xl max-h-[90vh] mx-4"
                        >
