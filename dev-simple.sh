...
cleanup() {
    ...
    FIREBASE_AUTH_EMULATOR_HOST='localhost:9190' FIRESTORE_EMULATOR_HOST='localhost:8085' node simple-persist.cjs save 2>/dev/null || true
...
echo "🔄 Cargando datos..."
FIREBASE_AUTH_EMULATOR_HOST='localhost:9190' FIRESTORE_EMULATOR_HOST='localhost:8085' node simple-persist.cjs load
