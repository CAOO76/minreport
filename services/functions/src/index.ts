import { initializeApp } from 'firebase-admin/app';import { initializeApp, getApps } from 'firebase-admin/app';

import { readFileSync } from 'fs';

// Inicializar Firebase Adminimport path from 'path';

initializeApp();import { fileURLToPath } from 'url';



// Exportar las funciones ultra simples// Obtener __dirname para módulos ES6

export { validateEmailAndStartProcess, getRequestStats } from './requestManagement';const __filename = fileURLToPath(import.meta.url);
