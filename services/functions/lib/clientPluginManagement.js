...
export async function handleManageClientPlugins(request) {
    var _a;
    ...
    try {
        ...
        await db.runTransaction(async (transaction) => {
            ...
            const currentPlugins = ((_a = accountDoc.data()) === null || _a === void 0 ? void 0 : _a.adminActivatedPlugins) || [];
...
export const manageClientPluginsCallable = functions.https.onCall({ region: 'southamerica-west1' }, (request) => {
