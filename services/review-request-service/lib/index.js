...
const auth = firebase_admin_1.default.auth(); // Get Firebase Auth instance
/**
...
app.post('/final-approve', async (req, res) => {
    ...
    try {
        ...
        const requestData = requestDoc.data(); // Cast to any for now, ideally use a defined type
        ...
        await requestRef.update({
            status: 'approved',
            approvedAt: firebase_admin_1.default.firestore.FieldValue.serverTimestamp(),
